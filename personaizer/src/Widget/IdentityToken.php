...
final class IdentityToken {
    ...
    public static function boot() {
        add_action( 'rest_api_init', static function () {
            register_rest_route( 'personaizer/v1', '/identity-token', array(
                'methods'             => 'GET',
    ...
    public static function mint() {
        ...
        $now = time();
        return new WP_REST_Response( array( 'token' => self::sign( array(
    ...
    public static function sign( array $payload, $secret ) {
        ...
        $header  = $b64url( wp_json_encode( array( 'alg' => 'HS256', 'typ' => 'JWT' ) ) );
